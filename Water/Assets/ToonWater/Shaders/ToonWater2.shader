Shader "Roystan/Toon/Water Tut2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
				//float maskTexcol = sin(tex2Dlod(_ColorTex, float4(TRANSFORM_TEX(v.uv,_ColorTex)+_Time.y*0.05,0,0)).r);
				
				//v.vertex.y -= maskTexcol*_Amount;	
