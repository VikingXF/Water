...
Shader "Babybus/Water/Unilt sufacewater4"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				v2f o;
				v.vertex.y += sin(_Time.y * _SpeedX + v.vertex.x*_Wave.x) * _Wave.z;
				v.vertex.y += sin(_Time.y * _SpeedZ + v.vertex.z*_Wave.y) * _Wave.w;
